...
|---|-------------|----------|----------|--------|------------|------------|
| 1 | Damage Calculator | Gameplay | MVP | Designed | design/gdd/damage-calculator.md | — |
| 2 | Status Effect System | Gameplay | MVP | Designed | design/gdd/status-effect-system.md | Damage Calculator |
